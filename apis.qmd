...
-   [US CENSUS API](https://cran.r-project.org/web/packages/tidycensus/index.html)

-   [Overpass API - Open Street Map](https://cran.r-project.org/web/packages/osmdata/vignettes/osmdata.html)
