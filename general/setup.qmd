...
4. In the **Anaconda Prompt**, run `conda env update -n geovis --file "C:\Users\YourName\Documents\geovis\geovis.yml" --prune || conda env create -n geovis --file "C:\Users\YourName\Documents\geovis\geovis.yml"`. This will create the environment, and install and update the necessary packages at once.
5. If you are prompted any questions, press `y`. This process will install all the packages necessary to carry out the lab sessions.
6. In the **Anaconda Prompt** write and run: `conda activate geovis`. This activates your working environment.
7. *Necessary on University machines, otherwise optional:* configuration of Jupyter Notebooks
...
Follow these instructions and test your installation **prior to the first Lab Session** (Mon, 26th of January). If you experience any issues, write a message on the MS Teams channel of the module.
...
4. In the **Terminal**, run `conda env update -n geovis --file "/Users/yourname/Documents/geovis/geovis.yml" --prune || conda env create -n geovis --file "/Users/yourname/Documents/geovis/geovis.yml"` This will create the environment, and install and update the necessary packages at once.

5. If you are prompted any questions, press `y`. This process will install all the packages necessary to carry out the lab sessions.

6. Activate the environment: `conda activate geovis`
