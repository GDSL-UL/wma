...
5. Write and run `jupyter notebook`. This should open Jupyter Notebook in your default browser. Navigate to your course folder and open the notebook downloaded in step 1. 
