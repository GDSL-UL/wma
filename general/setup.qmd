...
1. Type in the search bar and find the `Anaconda Prompt (miniconda 3)`. Launch it. The terminal should appear.

<img src = "../img/windows_anaconda.png" width="80%">

2. Download the `envs456.yml` from GitHub by cliciking `Download raw file`, top right, [here](https://github.com/GDSL-UL/wma/blob/main/envs456.yml) and save in the folder `envs456`.
...
6.  *Optional*: Configuration of Jupyter Notebooks
