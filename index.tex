...
\tightlist
\item
  \textbf{Title:} Exporing APIs in Plthon.
\item
...
\chapter*{Set up Miniconda (and Python) in
Windows}\label{set-up-miniconda-and-python-in-windows}
\addcontentsline{toc}{chapter}{Set up Miniconda (and Python) in Windows}

\markboth{Set up Miniconda (and Python) in Windows}{Set up Miniconda
(and Python) in Windows}
...
\item
  ...
  and the
  \href{https://minhaskamal.github.io/DownGit/\#/home?url=https://github.com/GDSL-UL/wma/tree/main/lab_img}{images}
...
\section*{Set up the Python
Environment}\label{set-up-the-python-environment}
\addcontentsline{toc}{section}{Set up the Python Environment}

\markright{Set up the Python Environment}
...
\item
  Download the file
  \href{https://github.com/GDSL-UL/wma/blob/main/envs456.yml}{envs456.yml}
  in the folder \texttt{envs456}.
\item
