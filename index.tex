...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w02_maps_files/figure-pdf/cell-5-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w02_maps_files/figure-pdf/cell-6-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w02_maps_files/figure-pdf/cell-7-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w02_maps_files/figure-pdf/cell-9-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w02_maps_files/figure-pdf/cell-10-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w02_maps_files/figure-pdf/cell-11-output-2.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w02_maps_files/figure-pdf/cell-13-output-2.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w02_maps_files/figure-pdf/cell-14-output-2.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w02_maps_files/figure-pdf/cell-16-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w02_maps_files/figure-pdf/cell-17-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w02_maps_files/figure-pdf/cell-19-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w02_maps_files/figure-pdf/cell-20-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w02_maps_files/figure-pdf/cell-21-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w02_maps_files/figure-pdf/cell-23-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w02_maps_files/figure-pdf/cell-26-output-2.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w02_maps_files/figure-pdf/cell-28-output-2.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w02_maps_files/figure-pdf/cell-29-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w02_maps_files/figure-pdf/cell-31-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w02_maps_files/figure-pdf/cell-33-output-2.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w02_maps_files/figure-pdf/cell-35-output-1.png}}

\pandocbounded{\includegraphics[keepaspectratio]{labs/w02_maps_files/figure-pdf/cell-35-output-2.png}}

\pandocbounded{\includegraphics[keepaspectratio]{labs/w02_maps_files/figure-pdf/cell-35-output-3.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w02_maps_files/figure-pdf/cell-38-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w02_maps_files/figure-pdf/cell-39-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w02_maps_files/figure-pdf/cell-41-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w02_maps_files/figure-pdf/cell-42-output-2.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w02_maps_files/figure-pdf/cell-45-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w02_maps_files/figure-pdf/cell-47-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w02_maps_files/figure-pdf/cell-48-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w02_maps_files/figure-pdf/cell-49-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w02_maps_files/figure-pdf/cell-51-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w02_maps_files/figure-pdf/cell-55-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w02_maps_files/figure-pdf/cell-56-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w03_webArch_files/figure-pdf/cell-11-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w03_webArch_files/figure-pdf/cell-12-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w03_webArch_files/figure-pdf/cell-16-output-2.png}}
...
\item
  ...
  \item
    ...
    query their database. Getting credentials for an API requires that
    you register with the organization. Once you have successfully
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w04_dataArch_files/figure-pdf/cell-9-output-1.png}}
...
\section{Mapbox}\label{mapbox}

\href{https://account.mapbox.com/auth/signup/?route-to=\%22https\%3A\%2F\%2Faccount.mapbox.com\%2Faccess-tokens\%2F\%22}{Register
for a MapBox account here.}

Once your account is created and verified, Save both your username and
public token as variables below:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mapbox\_user }\OperatorTok{=} \StringTok{\textquotesingle{}\textquotesingle{}} \CommentTok{\#Add your username here}
\NormalTok{mapbox\_token }\OperatorTok{=} \StringTok{\textquotesingle{}\textquotesingle{}} \CommentTok{\#Add your public token here (find this on the right hand side of the Mapbox console home page)}
\end{Highlighting}
\end{Shaded}

\section{Optional: Generating
.mbtiles}\label{optional-generating-.mbtiles}
...
\item
  ...
  environments, (i.e.~if your data filepath was C:\envs456\data, you
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w05_interactive_files/figure-pdf/cell-32-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w05_interactive_files/figure-pdf/cell-33-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w07_OSM_files/figure-pdf/cell-3-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w07_OSM_files/figure-pdf/cell-4-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w07_OSM_files/figure-pdf/cell-5-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w07_OSM_files/figure-pdf/cell-6-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w07_OSM_files/figure-pdf/cell-7-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w07_OSM_files/figure-pdf/cell-8-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w07_OSM_files/figure-pdf/cell-9-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w07_OSM_files/figure-pdf/cell-10-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w07_OSM_files/figure-pdf/cell-11-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w07_OSM_files/figure-pdf/cell-13-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w07_OSM_files/figure-pdf/cell-14-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w07_OSM_files/figure-pdf/cell-15-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w07_OSM_files/figure-pdf/cell-16-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w07_OSM_files/figure-pdf/cell-17-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w07_OSM_files/figure-pdf/cell-18-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w07_OSM_files/figure-pdf/cell-20-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w07_OSM_files/figure-pdf/cell-22-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w07_OSM_files/figure-pdf/cell-23-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w07_OSM_files/figure-pdf/cell-38-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w07_OSM_files/figure-pdf/cell-41-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w07_OSM_files/figure-pdf/cell-42-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w07_OSM_files/figure-pdf/cell-44-output-2.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w07_OSM_files/figure-pdf/cell-45-output-2.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/w07_OSM_files/figure-pdf/cell-46-output-2.png}}
...
We initially download 2 pages of GSP traces. We can try with higher
numbers to get more data. More recent traces are downloaded first.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{max\_pages }\OperatorTok{=} \DecValTok{2} \CommentTok{\# pages of data, }
\NormalTok{gps\_track\_points }\OperatorTok{=}\NormalTok{ get\_osm\_traces(max\_pages, bbox)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{gps\_track\_points.head()}
\end{Highlighting}
\end{Shaded}

\begin{longtable}[]{@{}llllll@{}}
\toprule\noalign{}
& track\_fid & track\_seg\_id & track\_seg\_point\_id & time &
geometry \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{gps\_track\_points.plot(markersize }\OperatorTok{=} \FloatTok{0.5}\NormalTok{) }\CommentTok{\# still are trackpoints still}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{labs/w09_advanced_files/figure-pdf/cell-10-output-1.png}}

\subsection{\texorpdfstring{Transform the \texttt{Point} GeoDataFrame in
a \texttt{LineString} GeoDataFrame with
\texttt{MovingPandas}}{Transform the Point GeoDataFrame in a LineString GeoDataFrame with MovingPandas}}\label{transform-the-point-geodataframe-in-a-linestring-geodataframe-with-movingpandas}
...
One can also convert the \texttt{TrajectoryCollection} (MovingPandas'
object) to a LineString \texttt{GeoDataFrame}. This would allow us to
take advantage of what we learnt across the previous sessions. For
example, we can plot through \texttt{GeoPandas} and \texttt{matplotlib}
after having projected the layer.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{crs }\OperatorTok{=} \StringTok{\textquotesingle{}EPSG:27700\textquotesingle{}}
\NormalTok{gps\_tracks }\OperatorTok{=}\NormalTok{ osm\_traces.to\_traj\_gdf()}
\NormalTok{gps\_tracks }\OperatorTok{=}\NormalTok{ gps\_tracks.set\_crs(}\StringTok{"EPSG:4326"}\NormalTok{).to\_crs(crs)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{labs/w09_advanced_files/figure-pdf/cell-16-output-1.png}}

As you can see, from the map above, OSM traces may include also odd
traces that jump from different locations of the city.

\textbf{Exercise}: Explore the \texttt{gps\_tracks} dataset and try to
compute the average speed of each of the tracks. Try to understand, also
using the \texttt{gps\_track\_points} (do not forget to project it, in
case), if you can find a way to filter out traces that follow very odd
routes.

\section{Animations in Folium}\label{animations-in-folium}

\subsection{Animating GPS tracks}\label{animating-gps-tracks}

\begin{Shaded}
\begin{Highlighting}[]
\ImportTok{from}\NormalTok{ folium.plugins }\ImportTok{import}\NormalTok{ TimestampedGeoJson}
\end{Highlighting}
\end{Shaded}

Download this
\href{\%22https://github.com/GDSL-UL/wma/blob/main/data/geolife_small.gpkg\%22}{file}
in your data folder.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{gdf }\OperatorTok{=}\NormalTok{ gpd.read\_file(}\StringTok{\textquotesingle{}../data/geolife\_small.gpkg\textquotesingle{}}\NormalTok{)}
\NormalTok{gdf[}\StringTok{\textquotesingle{}t\textquotesingle{}}\NormalTok{] }\OperatorTok{=}\NormalTok{ pd.to\_datetime(gdf[}\StringTok{\textquotesingle{}t\textquotesingle{}}\NormalTok{])}
\NormalTok{gdf }\OperatorTok{=}\NormalTok{ gdf.set\_index(}\StringTok{\textquotesingle{}t\textquotesingle{}}\NormalTok{).tz\_localize(}\VariableTok{None}\NormalTok{)}
\NormalTok{gdf.index.name }\OperatorTok{=} \VariableTok{None}
\NormalTok{gdf.plot(column }\OperatorTok{=} \StringTok{\textquotesingle{}trajectory\_id\textquotesingle{}}\NormalTok{, markersize }\OperatorTok{=} \DecValTok{1}\NormalTok{, cmap }\OperatorTok{=} \StringTok{\textquotesingle{}Set1\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{labs/w09_advanced_files/figure-pdf/cell-18-output-1.png}}

\begin{itemize}
\tightlist
\item
  \texttt{gdf{[}\textquotesingle{}t\textquotesingle{}{]}\ =\ pd.to\_datetime(gdf{[}\textquotesingle{}t\textquotesingle{}{]})}:
  This converts the values in the `t' column of \texttt{gdf} into
  datetime objects using \texttt{pd.to\_datetime()}. This is useful for
  time-series data where `t' likely represents time information.
\item
  \texttt{gdf\ =\ df.set\_index(\textquotesingle{}t\textquotesingle{}).tz\_localize(None)}:
  This sets the index to the column \texttt{t} and removes the timezone
  information using \texttt{tz\_localize(None)}
\end{itemize}
